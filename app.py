...
def screen_landing():
    st.markdown("""
    <div class="hero">
        <div class="hero-eyebrow">AI Product Intelligence</div>
    ...
    with col:
        st.markdown('<div class="demo-notice">💡 <strong>No API key?</strong> Click Load Demo for an instant Spotify teardown — no setup needed.</div>', unsafe_allow_html=True)
        ...
        <div style="margin-top:20px;text-align:center;">
            <p style="font-size:11px;color:#6E6E73;font-weight:600;text-transform:uppercase;letter-spacing:0.6px;margin-bottom:10px;">Try these</p>
            <div class="chip-row">
                <span class="chip">📸 Instagram</span><span class="chip">🍔 Uber Eats</span>
                <span class="chip">🎵 Spotify</span><span class="chip">🦆 Duolingo</span>
                <span class="chip">📝 Notion</span><span class="chip">🥗 AI Meal Planner</span>
            </div>
        </div>
        <p style="font-size:11px;color:#6E6E73;text-align:center;margin-top:20px;">
            Need an API key? Get one free at <strong>platform.openai.com/api-keys</strong>
        </p>
        """, unsafe_allow_html=True)
